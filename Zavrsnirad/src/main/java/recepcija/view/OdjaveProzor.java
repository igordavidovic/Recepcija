 ...
 * @author Igor
 */
public class OdjaveProzor extends javax.swing.JFrame {
    ...
    public OdjaveProzor() {
        ...
        setTitle(ZavrsniUtil.getNaslov("Odjave"));
        dpDatumOdjave.setDate(LocalDate.now());
        btnTrazi.doClick();
    }
    ...
    private void initComponents() {
        ...
        tblOdjave = new javax.swing.JTable();
        ...
        tblOdjave.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Šifra", "Korisnik", "Prijava", "Osobe", "Cijena"
            }
        ));
        jScrollPane1.setViewportView(tblOdjave);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(dpDatumOdjave, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
    ...
    private void btnTraziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTraziActionPerformed
        if (dpDatumOdjave.getDate() == null) {
            return;
        }
        datum = Date.from(dpDatumOdjave.getDate().atStartOfDay().atZone(ZoneId.systemDefault()).toInstant());
        TablicaModelOdjave m = new TablicaModelOdjave(op.readOdjava(datum));
        tblOdjave.setModel(m);
    }//GEN-LAST:event_btnTraziActionPerformed

    private void btnToExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnToExcelActionPerformed
        if (tblOdjave.getModel() == null || tblOdjave.getRowCount() == 0) {
            return;
        }
        c.setTime(datum);
        ...
        jfc.setSelectedFile(new File(System.getProperty("user.home")
                + File.separator + "Odjave_" + c.get(Calendar.DAY_OF_MONTH) + "_" + (c.get(Calendar.MONTH) + 1) + "_" + c.get(Calendar.YEAR) + ".xlsx"));
        if (jfc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                TableModel m = tblOdjave.getModel();
    ...
    private javax.swing.JTable tblOdjave;
